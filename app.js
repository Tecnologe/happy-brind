...
let trackList = [
    {
        name: "Fovever Young",
        artist: ">Alphaville",
        path: "./music/Y2meta.app - Alphaville - Forever Young ( Video Lyrics ) (320 kbps).mp3",
    },
    {
        name: "Feliz Cumpleaños",
        artist: "Borracho Feliz",
        path: "./musiC/Y2meta.app - Borracho cantado él Feliz cumpleaños!! Jajaj (320 kbps).mp3",
    },
    {
        name: "Dinosaurios",
        artist: "Niña vieja ",
        path: "./music/Y2meta.app - Las Mañanitas de los 🦕 DINOSAURIOS 🦕 - [DIVERTIDAS Y CHISTOSAS] 🤣😂 (320 kbps).mp3",
    },
    {
        name: "Cumpleaños",
        artist: "huevos",
        path: "./music/Y2meta.app - Las mañanitas al estilo huevos (128 kbps).mp3",
    },
];
